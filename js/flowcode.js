...
function Block(type, attrs) {
    ...
    this.width = _setting.blockwidth,
    this.height = _setting.blockheight,
    ...
    onStopDrag:function(e,n){
        ...
        if(flow.view._latestDrop === "view"){
            ...
            if(target.attr("blockid")){
                ...
                _action.changePosition(block.getPath(),newPs,{"x":block.x,"y":block.y});
...
flow.addError = function(msg,obj){
     flow._error.push({"msg":msg,"obj":obj});
     if(obj){
        flow.view.changeChoosed(obj);
     }
     alert(msg);
